...
class PA(batiment.Batiment):
    ...
    def __init__(self):
        ...
        self.armes = [C50, CanonAutomatique,
                      Mistral,MM40, Rafale]  # tableau des armes equipé [str], l'arme d'indice 0 est équipé d'office
        self.tier = 5  # tier du navire de 1 à 5
        self.status = True  # etat du navire ( vie /mort)
        self.imgpath = "assets/images/batiments/porteavion.png"